  ...
  <div id="yyw-Album">
    ...
    <div id="yyw-p-info">
      ...
      <div id="yyw-info">
        ...
        <router-link :to = "{path:'/MyHome' , query:{HomeUserId:userID,LoginUserId:currentUserID}}">
          <span style="position:relative;top:-103px;">查看ta的主页</span>
        </router-link>
      ...
      <el-row>
        ...
        >
          ...
          <el-card :body-style="{padding:'0px'}" class="yyw-card" style="margin-bottom:40px">
            <router-link
              :to="{path:'/Photo',query:{fromAlbum:item.AlbumId,fromAlbumName:item.AlbumName,fromAlbumIntro:item.AlbumIntroduction,fromAlbumTime:item.AlbumTime,fromAlbumCover:item.firstPhoto,userID:userID,currentUserID:currentUserID}}"
            >
  ...
  methods: {
    ...
    getPersonInfo: function () {
      ...
      this.getAjaxPersonInfo.open(
        'POST',
        'http://139.224.255.43:7779/Account/getUserInfoByID?user_id=' + this.userID,
        true
      )
