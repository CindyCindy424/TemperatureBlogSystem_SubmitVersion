  ...
  <div id="yyw-Photo">
    ...
    <div id="yyw-album-header">
      <span id="yyw-album-return">
        <router-link :to="{path:'/Album',query:{userID:this.userID,currentUserID:this.currentUserID}}"  id="yyw-return">相册 ></router-link>
      ...
      <el-row>
        ...
        >
          <img
            ...
            v-if="ispDelete"
            style="position:relative; left:132px; top:89px; width:23px; height:23px; z-index:3; cursor:pointer;"
    ...
    <div id="yyw-view-photo" v-if="isView">
      ...
      <div class="yyw-right-block">
        ...
        <img
          src="/static/images/beforelike.png"
          class="yyw-icon-like"
          @click="addLikes"
          style="cursor:pointer"
          ref="likes"
